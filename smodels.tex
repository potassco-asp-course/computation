...
\begin{frame}{Approximating stable models}
  ...
  \item<4-> \structure{Properties} \
    ...
    \smallskip
    \begin{itemize}\normalsize
    \item<5-> If $L\subseteq X$,\pause[5]\
      then $X\subseteq\Cn{\reduct{P}{L}}$
    \smallskip
    \item<7-> If $X\subseteq U$,\pause[7]\
      then $\Cn{\reduct{P}{U}}\subseteq X$
    \smallskip
    \item<9-> If $L\subseteq X\subseteq U$,\pause[9]\
      then $L\cup\Cn{\reduct{P}{U}}\subseteq X\pause[10]\subseteq U\cap\Cn{\reduct{P}{L}}$
    \end{itemize}
  \end{itemize}
\end{frame}
% ----------------------------------------------------------------------
...
\begin{frame}{Let's expand with $d$~!}
  ...
  \item<2-> []
    ...
    \]
    \medskip
  \item<7-> \structure{Result} \ $\{a,b,d\}$ is a stable model of $P$
  \end{itemize}
\end{frame}
% ------------------------------------------------------------
