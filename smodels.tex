...
\begin{frame}{An example}
  ...
  \item<2-> []
    ...
    \]
    \medskip
  \item<9-> \structure{Result} \  For every stable model $X$ of $P$
    \par\smallskip
    \quad
...
\begin{frame}{Let's expand with $d$~!}
  ...
  \item<2-> []
    ...
    \]
    \medskip
  \item<5-> \structure{Result} \ $\{a,b,d\}$ is a stable model of $P$
  \end{itemize}
\end{frame}
% ------------------------------------------------------------
\begin{frame}{Let's expand with $\neg d$~!}
  ...
  \item<2-> []
    ...
    \]
    \medskip
  \item<5-> \structure{Result} \ $\{a,b,e\}$ is a stable model of $P$
  \end{itemize}
\end{frame}
% ------------------------------------------------------------
